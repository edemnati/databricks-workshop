...
# MAGIC
# MAGIC Ref: https://learn.microsoft.com/en-us/azure/databricks/_extras/notebooks/source/machine-learning/automl-feature-store-example.html
...
# MAGIC %sql 
# MAGIC CREATE DATABASE IF NOT EXISTS main.feature_store_taxi_example;
...
import uuid
feature_database = "main.feature_store_taxi_example"
...
print(pickup_features_table)
print(dropoff_features_table)
