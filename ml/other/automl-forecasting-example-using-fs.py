...
# MAGIC %sql 
# MAGIC CREATE DATABASE IF NOT EXISTS main.feature_store_covid_example;

# COMMAND ----------

# MAGIC %md
# MAGIC If you are not using a runtime >= 13.3 LTS ML, you  need to install the feature store engineering package:
# MAGIC
...
import uuid
feature_database = "main.feature_store_covid_example"
#random_id = str(uuid.uuid4())[:8]
covid19_ts_features_table = f"{feature_database}.covid19_ts_features" #_{random_id}"

# COMMAND ----------

print(covid19_ts_features_table)
...
fs.create_table(
    name=covid19_ts_features_table,
    primary_keys=["date"],
    df=df,
    partition_columns="yyyy_mm",
    description="Covid 19 from 2020-01-21 to 2021-03-11",
)
...
feature_store_lookups = [
  {
     "table_name": covid19_ts_features_table,
     "lookup_key": ["cases", "date"],
  },
...
summary = databricks.automl.regress(df, 
                                    target_col="cases", 
                                    timeout_minutes=5, 
